...
from keyboards.default.keyboard_menu import promo_menu,kb_menu
            ...
            if promo_check == True:
                ...
                if active_check == False:
                    await message.answer(f'Вы уже активировали данный промокод!\n'
                                         f'Не жульничай 😉', reply_markup=kb_menu)
                    await state.finish()
                else:
                    ...
                    await message.answer(f'Промокод успешно активирован!\n'
                                         f'На ваш баланс зачислено {promo_amount}', reply_markup=kb_menu)
                    await state.finish()
